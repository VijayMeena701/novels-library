	...
	return (
		<Card className="p-[1.1rem] flex flex-col md:flex-row gap-6 bg-surface border-default shadow-elevation-2">
			...
			<div className="flex-1 min-width-0 flex flex-col gap-4 text-primary">
				<div>
					<h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold tracking-tight leading-tight text-primary">{book.title}</h1>
				...
				<div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-2.5">
					...
					<div className="p-3 border border-default rounded-md bg-surface-raised">
						...
						<strong className="text-primary font-extrabold text-sm">{book.translatedChaptersTotal || chaptersCount || "?"}</strong>
					</div>
					<div className="p-3 border border-default rounded-md bg-surface-raised">
					...
					<div className="p-3 border border-default rounded-md bg-surface-raised">
						...
						<strong className="text-primary font-extrabold text-sm">
							...
							{book.ratingCount ? <span className="text-muted font-semibold text-xs ml-1">({book.ratingCount})</span> : null}
						</strong>
					</div>
					<div className="p-3 border border-default rounded-md bg-surface-raised">
