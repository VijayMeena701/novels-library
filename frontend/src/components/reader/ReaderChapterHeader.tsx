...
export function ReaderChapterHeader({
  ...
  return (
    <header className="border-b border-reader pb-8">
      <h1 className="text-balance text-[1.75rem] font-bold leading-tight tracking-tight max-[860px]:text-[1.45rem]">
        {displayChapterTitle}
      </h1>
        ...
        {chapter.sourceUrl && (
          <>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="underline underline-offset-2 transition hover:text-reader-paragraph"
            >
              Source
            </a>
          </>
