...
import { type CSSProperties, forwardRef, memo, type MouseEvent } from 'react';
...
const ReaderChapterContentInner = forwardRef<HTMLDivElement, ReaderChapterContentProps>(
  function ReaderChapterContent({ content, fontSize, onClick }, ref) {
...
export const ReaderChapterContent = memo(ReaderChapterContentInner);
