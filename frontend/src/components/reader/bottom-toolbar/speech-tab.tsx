	...
	return (
		<div className="flex flex-col gap-1.5">
			...
			<div className="flex items-center gap-2">
				<div
					className="size-9 shrink-0 rounded-lg border border-reader"
	...
	return (
		<div className="flex flex-col gap-6">
			<div>
				...
				<p className="mt-1 text-xs leading-relaxed text-reader-muted">Tune the voice and optional highlights without leaving the chapter.</p>
			</div>
