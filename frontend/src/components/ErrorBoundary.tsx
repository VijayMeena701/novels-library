...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <section
        className="mx-auto my-8 w-full max-w-2xl rounded-2xl border border-rose-200 bg-rose-50 p-6 text-rose-950 shadow-elevation-1"
        role="alert"
      >
        ...
        <button
          type="button"
          onClick={this.reset}
          className="mt-5 rounded-lg bg-rose-700 px-4 py-2 text-sm font-bold text-inverse hover:bg-rose-800"
        >
          Try again
        </button>
      </section>
