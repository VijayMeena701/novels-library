  ...
  return (
    <section className="flex flex-col gap-4">
      <div className="flex items-center justify-between gap-4">
        <h2 className="font-serif text-xl font-medium text-primary">Featured Pick</h2>
      </div>
      <Card className="overflow-hidden p-0">
        <div className="grid md:grid-cols-[180px_1fr]">
          <div className="relative min-h-[200px] bg-gradient-to-br from-surface to-surface-muted md:min-h-[240px]">
          ...
          <div className="flex flex-col gap-3 p-4 sm:p-6">
            ...
            <h3 className="line-clamp-2 break-words font-serif text-2xl font-medium text-primary">
              <Link href={`/books/${book._id}`}>{book.title}</Link>
            </h3>
            <p className="truncate text-sm text-muted">by {getAuthor(book)}</p>
            <p className="line-clamp-3 break-words text-sm leading-relaxed text-secondary">
