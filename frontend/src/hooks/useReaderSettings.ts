    ...
    async function initializeReaderSettings() {
      ...
      try {
        ...
        if (reader) {
          ...
          if (reader.playbackEngine)
            setPlaybackEngine(normalizePlaybackEngine(reader.playbackEngine as PlaybackEngineName, allowLocalTts));
          ...
          if (reader.sentenceHighlightOpacity !== undefined)
            setSentenceHighlightOpacity(reader.sentenceHighlightOpacity);
