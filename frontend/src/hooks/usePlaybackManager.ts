...
import type { PlaybackConfig, PlaybackEngineName, PlaybackState, PlaybackVoice } from '@/lib/tts/playback';
...
export interface UsePlaybackManagerReturn {
  play: (
    ...
    callbacks: {
      onStart?: () => void;
      onEnd?: () => void;
      onBoundary?: (event: { name: 'word' | 'sentence' | ''; charIndex: number; charLength?: number }) => void;
