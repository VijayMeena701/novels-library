  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md border border-transparent text-sm font-semibold transition-[background-color,border-color,color,box-shadow,transform] duration-button ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-surface-raised text-primary border-default hover:bg-surface-hover',
        ghost: 'bg-transparent text-primary hover:bg-surface-raised',
        outline: 'bg-transparent text-primary border-default hover:bg-surface-raised',
        destructive:
        ...
        reader: 'bg-reader-surface text-accent border-reader hover:bg-reader-toolbar',
        floating: 'bg-accent text-on-accent shadow-elevation-3 hover:bg-accent-hover hover:shadow-elevation-4',
        toolbar: 'bg-transparent text-muted hover:bg-surface-raised hover:text-primary',
      },
      size: {
