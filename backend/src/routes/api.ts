...
export async function apiRoutes(fastify: FastifyInstance) {
  ...
  fastify.get(
    '/public/books/:id/reviews',
    { preHandler: requireCapability(CAPABILITY.BOOKS_READ, { allowAnonymous: true }) },
    getBookReviewsHandler,
  );
  fastify.get(
    '/public/books/:id/chapters',
    { preHandler: requireCapability(CAPABILITY.CHAPTERS_READ, { allowAnonymous: true }) },
    listPublicChaptersHandler,
  );
  fastify.get(
    '/public/books/:id/chapters/:chapterNumber',
    { preHandler: requireCapability(CAPABILITY.CHAPTERS_READ, { allowAnonymous: true }) },
    getPublicChapterHandler,
  );
  fastify.get(
    '/public/books/:id/raw-chapters',
    { preHandler: requireCapability(CAPABILITY.CHAPTERS_READ_RAW, { allowAnonymous: true }) },
    listPublicRawChaptersHandler,
  );
  fastify.get(
    '/public/books/:id/raw-chapters/:chapterNumber',
    { preHandler: requireCapability(CAPABILITY.CHAPTERS_READ_RAW, { allowAnonymous: true }) },
    getPublicRawChapterHandler,
  );
  fastify.get(
  ...
  fastify.register(async (protectedGroup) => {
    ...
    protectedGroup.get(
      '/auth/capabilities',
      { preHandler: requireCapability(CAPABILITY.PROFILE_READ) },
      getCapabilitiesHandler,
    );

    protectedGroup.get(
      '/settings',
      { preHandler: requireCapability(CAPABILITY.SETTINGS_READ) },
      getUserSettingsHandler,
    );
    protectedGroup.put(
      '/settings',
      { preHandler: requireCapability(CAPABILITY.SETTINGS_UPDATE) },
    ...
    protectedGroup.delete(
      '/books/:id',
      { preHandler: requireCapability(CAPABILITY.LIBRARY_DELETE) },
      deleteBookHandler,
    );
    protectedGroup.post(
      '/books/:id/cover/sync',
    ...
    protectedGroup.get(
      '/catalog/books',
      { preHandler: requireCapability(CAPABILITY.BOOKS_LIST) },
      listCatalogBooksHandler,
    );
    protectedGroup.put(
      '/catalog/books/:id',
    ...
    protectedGroup.put(
      '/authors/:id',
      { preHandler: requireCapability(CAPABILITY.AUTHORS_MANAGE) },
      upsertAuthorHandler,
    );
    ...
    protectedGroup.get(
      '/books/:id/re-read',
      { preHandler: requireCapability(CAPABILITY.SESSIONS_READ) },
      listReadingSessionsHandler,
    );
    protectedGroup.post(
      '/books/:id/re-read',
    ...
    protectedGroup.put(
      '/books/:id/re-read/:sessionId',
      { preHandler: requireCapability(CAPABILITY.SESSIONS_MANAGE) },
      updateReadingSessionHandler,
    );

    protectedGroup.get(
      '/books/:id/pronunciation-rules',
    ...
    protectedGroup.get(
      '/books/:id/chapters/:chapterNumber',
      { preHandler: requireCapability(CAPABILITY.CHAPTERS_READ) },
      getChapterHandler,
    );
    protectedGroup.get(
      '/books/:id/raw-chapters',
      { preHandler: requireCapability(CAPABILITY.CHAPTERS_READ_RAW) },
      listRawChaptersHandler,
    );
    protectedGroup.get(
      '/books/:id/raw-chapters/:chapterNumber',
      { preHandler: requireCapability(CAPABILITY.CHAPTERS_READ_RAW) },
      getRawChapterHandler,
    );
    protectedGroup.post(
      '/books/:id/raw-chapters/:chapterNumber/translate',
    ...
    protectedGroup.post(
      '/books/:id/chapters/:chapterNumber/visits',
      { preHandler: requireCapability(CAPABILITY.CHAPTERS_VISIT) },
      recordChapterVisitHandler,
    );
    ...
    protectedGroup.get(
      '/jobs/book/:bookId',
      { preHandler: requireCapability(CAPABILITY.JOBS_LIST) },
      getJobsForBookHandler,
    );
    protectedGroup.post(
      '/jobs/:jobId/retry',
      { preHandler: requireCapability(CAPABILITY.JOBS_RETRY) },
      retryJobHandler,
    );
    protectedGroup.post(
      '/jobs/:jobId/manual-intervention',
    ...
    protectedGroup.post(
      '/jobs/book/:bookId/scrape-now',
      { preHandler: requireCapability(CAPABILITY.JOBS_SCRAPE) },
      runScrapeNowHandler,
    );
    protectedGroup.post(
      '/jobs/book/:bookId/scrape',
      { preHandler: requireCapability(CAPABILITY.JOBS_SCRAPE) },
      triggerScrapeHandler,
    );
    ...
    protectedGroup.get(
      '/admin/users/:id',
      { preHandler: requireCapability(CAPABILITY.ADMIN_ACCESS) },
      getUserByIdHandler,
    );
    protectedGroup.put(
      '/admin/users/:id',
